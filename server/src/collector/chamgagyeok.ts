 ...
 * 참가격은 가공식품 중심이라 신선 과일(사과·수박 등)·생닭·한우 생육은 없다 —
 * 실측으로 존재가 확인된 상품만 나열한다. 단위가 KAMIS와 달라도
 * 상품명에 단위가 병기되므로 참고 정보로 문제 없다.
 */
export const LOCAL_PRODUCT_MAP: ReadonlyMap<string, readonly string[]> =
  new Map([
    ['cabbage', ['배추(1.5~2kg)']],
    ['cabbage-round', ['양배추']],
    ['radish', ['무(줄기 없는 무, 1.5kg)']],
    ['carrot', ['당근(흙당근, 100g)']],
    ['spinach', ['시금치(250~400g)']],
    ['lettuce', ['적상추(100g)']],
    ['cucumber', ['오이(백다다기)']],
    ['zucchini', ['애호박']],
    ['garlic', ['마늘(깐마늘, 100g)']],
    ['green-pepper', ['풋고추(100g)']],
    ...
    [
      ...
      [
        ...
        '남양유업 맛있는우유GT(900ml)',
        '파스퇴르우유 후레쉬(900ml)',
        '남양 아인슈타인 무항생제 우유(900ml)',
      ],
    ],
    [
      'rice',
      ['철원 오대쌀(10kg)', '김천 금물쌀(10kg)', '바른고을 의성진쌀(10kg)', '임금님표 이천쌀(4kg)'],
    ],
    ['laver', ['들기름 재래 도시락김(12봉)']],
